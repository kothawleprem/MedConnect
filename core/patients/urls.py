...
from .views import EmailView, VerifyEmailView, DoctorSearchView, DoctorsBySpecializationView, DoctorProfileView, PatientSlotView, ManageConsultationsView, ConsultationView
